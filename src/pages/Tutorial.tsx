        ...
        <IonSlides ref={slideRef} onIonSlideWillChange={handleSlideChangeStart} pager={false}>
          <IonSlide>
            ...
            <h2 className="slide-title">
              Welcome to <b>Tiger 21 Demo Conference</b>
            </h2>
            <p>
              This <b>Tiger 21 Demo Conference</b> is a practical preview of the ionic react framework in action, and a demonstration of sleak sexy stuff.
            </p>
          </IonSlide>
